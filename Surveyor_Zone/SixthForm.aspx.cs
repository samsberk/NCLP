...
public partial class Surveyor_Zone_SixthForm : System.Web.UI.Page
{
    string cmd;
    int a = 1;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (dsd.Rows.Count > 0)
            {
                ...
                txt1.Text = c1;
                cmd = "select * from Form6 where UnNo='" + unno + "' and c1='" + c1 + "'";
    ...
    {
        string unno = em.DecryptMyData(Request.QueryString["AppID"]);
        Response.Redirect("Form_5_of_6?AppID=" + em.EncryptMyData(unno) + "&AppID2=" + em.EncryptMyData(a.ToString()) + "");
    }
        ...
        else
        {
            ...
            if (dsd.Rows.Count > 0)
            {
                ...
                if (dcunno.Rows.Count > 0)
                {
                    ...
                    {
                        atid++;
                        Response.Redirect("Form_6_of_6?AppID=" + em.EncryptMyData(unno) + "&AppID2=" + em.EncryptMyData(atid.ToString()) + "");
                    }
                    else
                    {
                        Response.Write("<script>alert('Something went wrong, please try again later.')</script>");
