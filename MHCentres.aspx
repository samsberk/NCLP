<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MHCentres.aspx.cs" Inherits="MHCentres" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Mental Health Centres | Mental Health Mission India</title>
						...
						<nav class="navbar navbar-default my-nav">
							...
							<div class="collapse navbar-collapse my-collapse" id="myNavbar2">
								<ul class="nav navbar-nav navbar-right my-navbar-nav">
									...
									<li class="active"><a class="link-b" href="Mental_Health_Centres">MH CENTRES</a></li>
